...
public class AutoCitadelBuilder : EditorWindow
{
    ...
    public static void BuildCitadelScene()
    {
        ...
        // --- Music Reverb & Ambient SFX (placeholder) ---
        GameObject reverbZone = new GameObject("MusicReverbZone");
        // Add AudioReverbZone or custom component as needed
        GameObject ambientSFX = new GameObject("AmbientSFXLoop");
        // Add AudioSource and assign loop clip in Unity
